...
Cry_Hoothoot_Ch8:
	...
	noise_note 1, 9, 8, 94
	noise_note 16, 10, 2, 110
	sound_ret

Cry_Sentret_Ch5:
	toggle_perfect_pitch
	duty_cycle 0
	sound_loop 0, Cry_Sentret_Ch6.body
...
Cry_Mareep_Ch5:
	toggle_perfect_pitch
	duty_cycle 0
	sound_loop 0, Cry_Mareep_Ch6.body
...
Cry_Cyndaquil_Ch6:
	duty_cycle 2
	square_note 8, 2, -7, 263 + 768
.loop1:
	square_note 0, 14, 1, 1155 + 768
	square_note 0, 5, 1, 1102 + 768
	sound_loop 4, .loop1
.loop2:
	square_note 0, 14, 1, 986 + 768
	square_note 1, 5, 1, 786 + 768
	sound_loop 4, .loop2
	sound_ret
...
Cry_Gligar_Ch5:
	...
	square_note 4, 3, -2, 1853 - 512
	square_note 6, 15, 8, 1890 - 512
	square_note 6, 15, 8, 1888 - 512
	square_note 6, 15, 1, 1886 - 512
Cry_Gligar_Ch6:
	sound_ret
...
Cry_Girafarig_Ch5:
	duty_cycle 1
	toggle_perfect_pitch
	sound_loop 0, Cry_Girafarig_Ch6.body
...
Cry_Ledyba_Ch5:
	toggle_perfect_pitch
	duty_cycle 2
	sound_loop 0, Cry_Ledyba_Ch6.body
...
Cry_Natu_Ch5:
	...
	square_note 4, 15, 8, 1969 - 167
	square_note 4, 15, 8, 1968 - 167
	square_note 4, 4, 8, 1967 - 167
	square_note 4, 15, 8, 1970 - 167
	square_note 4, 15, 8, 1971 - 167
	square_note 4, 4, 8, 1972 - 167
	square_note 0, 4, 1, 1972 - 167
	sound_ret

Cry_Sunflora_Ch5:
	duty_cycle 0
	square_note 4, 15, 8, 1969 - 243
	square_note 4, 15, 8, 1968 - 243
	square_note 4, 4, 8, 1967 - 243
	square_note 4, 15, 8, 1970 - 243
	square_note 4, 15, 8, 1971 - 243
	square_note 4, 4, 8, 1972 - 243
	square_note 0, 4, 1, 1972 - 243
	sound_ret
...
Cry_Natu_Ch6:
	...
	square_note 4, 15, 8, 1970 - 167
	square_note 4, 15, 8, 1969 - 167
	square_note 4, 2, 8, 1968 - 167
	square_note 4, 15, 8, 1972 - 167
	square_note 4, 15, 8, 1974 - 167
	square_note 4, 4, 8, 1976 - 167
	square_note 0, 4, 1, 1976 - 167
	sound_ret
...
Cry_Sunflora_Ch6:
	...
	square_note 4, 15, 8, 1970 - 243
	square_note 4, 15, 8, 1969 - 243
	square_note 4, 2, 8, 1968 - 243
	square_note 4, 15, 8, 1972 - 243
	square_note 4, 15, 8, 1974 - 243
	square_note 4, 4, 8, 1976 - 243
	square_note 0, 4, 1, 1976 - 243
	sound_ret

Cry_Natu_Ch8:
	noise_note 4, 8, 8, 5 + 89
	noise_note 4, 8, 8, 4 + 89
	noise_note 4, 3, 8, 3 + 89
	noise_note 4, 8, 8, 5 + 89
	noise_note 4, 8, 8, 4 + 89
	noise_note 4, 8, 7, 4 + 89
	noise_note 0, 7, 1, 4 + 89
	sound_ret
...
Cry_Mantine_Ch5:
	duty_cycle 0
	square_note 4, 15, 8, 1969 - 190
	square_note 4, 15, 8, 1968 - 190
	square_note 4, 4, 8, 1967 - 190
.loop:
	square_note 4, 15, 8, 1970 - 190
	square_note 4, 15, 8, 1971 - 190
	square_note 4, 4, 8, 1972 - 190
	sound_loop 2, .loop
	square_note 0, 4, 1, 1972 - 190
	sound_ret
...
Cry_Mantine_Ch6:
	...
	square_note 4, 15, 8, 1970 - 190
	square_note 4, 15, 8, 1969 - 190
	square_note 4, 2, 8, 1968 - 190
.loop:
	square_note 4, 15, 8, 1972 - 190
	square_note 4, 15, 8, 1974 - 190
	square_note 4, 4, 8, 1976 - 190
	sound_loop 2, .loop
	square_note 0, 4, 1, 1976 - 190
	sound_ret

Cry_Mantine_Ch8:
	noise_note 4, 8, 8, 5 + 66
	noise_note 4, 8, 8, 4 + 66
	noise_note 4, 3, 8, 3 + 66
.loop:
	noise_note 4, 8, 8, 5 + 66
	noise_note 4, 8, 8, 4 + 66
	noise_note 4, 8, 7, 4 + 66
	sound_loop 2, .loop
	noise_note 0, 8, 1, 4 + 66
	sound_ret
